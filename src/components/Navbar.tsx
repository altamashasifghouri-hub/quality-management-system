        ...
        <div className="flex items-center gap-4">
          <div className="relative" ref={ref}>
            <button
              ...
              className={`inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg border border-white/10 transition-all duration-200 ${
            ...
            >
              ...
              Settings
              <svg className={`w-4 h-4 transition-transform duration-200 ${open ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">

...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-blue-900/70 to-slate-950 px-4">
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-gradient-to-br from-blue-600/20 via-blue-900/30 to-slate-900/40 backdrop-blur-md border border-blue-400/25 rounded-2xl p-8 shadow-2xl">
        ...
        <div className="mt-6 text-center">
          <p className="text-blue-200/60 text-sm mb-3">Just viewing reports? No sign-in needed.</p>
          <Link
            href="/public"
            className="inline-flex items-center justify-center gap-2 w-full px-4 py-3 bg-white/5 border border-blue-400/30 text-white text-sm font-medium rounded-lg hover:border-blue-400/60 hover:bg-blue-500/10 transition-all duration-200"
          >
            ...
            Public view (Audit & CAPA reports)
          </Link>
        </div>
      </div>
    </div>
